...
#define SX126X_SLEEP_START_WARM \
    0b00000100  //  2     2                 warm start, configuration is
                //  retained
...
#define SX126X_RX_TX_FALLBACK_MODE_STDBY_RC \
    0x20  //  7     0                        standby with RC oscillator
          //  (default)
...
#define SX126X_GFSK_PACKET_FIXED \
    0x00  //  7     0     GFSK packet type: fixed (payload length known in
          //  advance to both sides)
...
#define SX126X_CAD_GOTO_RX \
    0x01  //  7     0     after CAD is done, go to Rx mode if activity is
          //  detected
...
#define SX126X_XOSC_START_ERR \
    0b000100000  //  5     5                    crystal oscillator failed to
                 //  start
