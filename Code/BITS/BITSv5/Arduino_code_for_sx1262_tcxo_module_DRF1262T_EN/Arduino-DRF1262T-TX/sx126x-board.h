...
#define  USER_MODE_TX        1
#define  USER_MODE_RX        0
...
const int Led1RedPin   = 16;
const int Led1BluePin  = 15;
const int NResetPin     = 14;
 ...
 */
void SX126xReadCommand( uint8_t opcode, uint8_t *buffer, uint16_t size );
