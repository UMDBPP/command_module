...
//----------------------------------------------------------------Configuration
// Hex------------------------------------------------------------------------------------
// This section contains the preconfigured arrays of hex to change GPS
// configurations. Could be partially calculated in advance, but no need

//-----------------------------------------Disable Unused
// Messages---(UBX-CFG-MSG)----------------------------------
void gps_nuke_messages() {

  const char nuke_msg[] PROGMEM = {
      0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x04,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x3F, // RMC
      0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x01,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2A, // GLL
      0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x02,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x31, // GSA
      0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x03,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x38, // GSV
      0xB5, 0x62, 0x06, 0x01, 0x08, 0x00, 0xF0, 0x05,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x46 // VTG
  };
...
void gps_set_GGA() {
  ...
  const char gga_msg[] PROGMEM = {0xB5, 0x62, 0x06, 0x01, 0x08, 0x00,
                                  0xF0, 0x00, 0x00, 0x01, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x28};
...
void set_gps_one_hertz() {
  const char one_hertz[] PROGMEM = {0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, 0xE8,
...
void set_gps_five_hertz() {
  const char five_hertz[] PROGMEM = {0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, 0xC8,
...
void set_gps_ten_hertz() {
  const char ten_hertz[] PROGMEM = {0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, 0x64,
...
void gps_set_baud_default() { // 9600
  ...
  const char defaultBaud[] PROGMEM = {0xB5, 0x62, 0x06, 0x00, 0x14, 0x00, 0x01,
...
void gps_set_baud_fast() { // 115200
  ...
  const char quickBaud[] PROGMEM = {0xB5, 0x62, 0x06, 0x00, 0x14, 0x00, 0x01,
                                    0x00, 0x00, 0x00, 0xD0, 0x08, 0x00, 0x00,
...
void gps_set_baud_ultra() {
  ...
  const char ultraBaud[] PROGMEM = {// 921600
                                    ...
                                    0x00, 0x00, 0x00, 0xD0, 0x08, 0x00, 0x00,
                                    0x00, 0x10, 0x0E, 0x00, 0x07, 0x00, 0x03,
                                    0x00, 0x00, 0x00, 0x00, 0x00, 0x1B, 0x5A};
...
bool gps_set_navmode_one_g() {
  ...
  const char navmode_poll[] PROGMEM = {0xB5, 0x62, 0x06, 0x24,
                                       0x00, 0x00, 0x2A, 0x84};
...
//   ,0xDE ,0x6A, //5Hz // <CHECK> This is correct, maybe not allowed in
//   airborne mode?
//   //0xB5 ,0x62 ,0x06 ,0x08 ,0x06 ,0x00 ,0x64 ,0x00 ,0x01 ,0x00 ,0x01 ,0x00
//   ,0x7A ,0x12, //10Hz
//   //BAUD
//   //0xB5 ,0x62 ,0x06 ,0x00 ,0x14 ,0x00 ,0x01 ,0x00 ,0x00 ,0x00 ,0xD0 ,0x08
//   ,0x00 ,0x00 ,0x80 ,0x25 ,0x00 ,0x00 ,0x07 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00
//   ,0x00 ,0x00 ,0xA2 ,0xB5, //9600 0xB5 ,0x62 ,0x06 ,0x00 ,0x14 ,0x00 ,0x01
//   ,0x00 ,0x00 ,0x00 ,0xD0 ,0x08 ,0x00 ,0x00 ,0x00 ,0xC2 ,0x01 ,0x00 ,0x07
//   ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0xC0 ,0x7E, //115200
//   //AIRBORNE 4g
//   //NEW
//   0xB5, 0x62, 0x06, 0x24, 0x24, 0x00, 0xFF, 0xFF, 0x06, 0x03, 0x00, 0x00,
//   0x00, 0x00, 0x10, 0x27, 0x00, 0x00, 0x05, 0x00, 0xFA, 0x00, 0xFA, 0x00,
//   0x64, 0x00, 0x2C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00,
//   0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4D, 0xDB,
////0xB5 ,0x62 ,0x06 ,0x24 ,0x24 ,0x00 ,0xFF ,0xFF ,0x08 ,0x03 ,0x00 ,0x00 ,0x00
///,0x00 ,0x10 ,0x27 ,0x00 ,0x00 ,0x05 ,0x00 ,0xFA ,0x00 ,0xFA ,0x00 ,0x64 ,0x00
///,0x2C ,0x01 ,0x00 ,0x3C ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00
///,0x00 ,0x00 ,0x00 ,0x54 ,0x2C,
//  //SAVE
//  0xB5 ,0x62 ,0x06 ,0x09 ,0x0D ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0xFF ,0xFF ,0x00
//  ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x1D ,0xAB
//};
//
//
// void GPSINIT(){
...
void output() {
  ...
  if (gpsInfo.GPSSats != -1) {
    gpspacket = String(gpsInfo.GPSTime) + "," + String(gpsInfo.GPSLat, 6) +
                "," + String(gpsInfo.GPSLon, 6) + "," + gpsInfo.GPSAlt + "," +
                gpsInfo.GPSSats;
  } else {
    // gpspacket = String(preserve.GPSTime/100)+","+String(preserve.GPSLat,6) +
    // "," + String(preserve.GPSLon,6)+","+preserve.GPSAlt+","+preserve.GPSSats;
    gpspacket = "err" + String(gpsInfo.GPSTime / 100) + "," +
                String(gpsInfo.GPSLat, 6) + "," + String(gpsInfo.GPSLon, 6) +
                "," + gpsInfo.GPSAlt + "," + gpsInfo.GPSSats;
  }
